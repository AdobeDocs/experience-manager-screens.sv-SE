...
Med hjälp av ***Screens Launch*** kan författarna förhandsgranska varje kanal i programstarten och bör kunna initiera en granskningsbegäran. Godkännargruppen får meddelanden och kan godkänna eller avvisa begäran. När live-datumet nås spelas innehållet upp på enheterna.
...
Eftersom du har angett Respitperiod till 10 minuter i föregående exempel, och du anger ett direktdatum för alla starter för resurserna under */innehåll/skärmar*, börjar kampanjen med den här förskjutningen.
...
När starttiden har skapats kan du uppdatera egenskaperna, till exempel live-datum, starttitel och kampanjomfång, med hjälp av **startegenskaperna**.
