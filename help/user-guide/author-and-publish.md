...
>[!NOTE]
>
>Om du vill veta mer om författaren och publiceringen av en arkitekturöversikt och hur innehållet skrivs på en AEM författarinstans och sedan publiceras på flera publiceringsinstanser kan du läsa [Författaröversikt och Översikt över](author-publish-architecture-overview.md)publiceringsarkitekturen.
...
1. Navigera till din AEM —> hammer icon —> **Operations** —> **Configuration**.
...
>[!NOTE]
>
>När du har aktiverat enheten kan du också redigera eller uppdatera server-URL:en genom att klicka på **Redigera server-URL** i åtgärdsfältet, som visas i bilden nedan, så sprids ändringarna till AEM Screens-spelaren.
...
1. Klicka på **Enhetshanteraren** i åtgärdsfältet.
1. Markera enheten och klicka på **Redigera server-URL** i åtgärdsfältet, så som visas i bilden nedan, så sprids ändringarna till AEM Screens-spelaren.
