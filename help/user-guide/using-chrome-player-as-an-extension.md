...
1. När spelaren har laddat ned innehåll lokalt kan du bläddra i lokalt nedladdat innehåll genom att gå till `http://localhost:24502`.
...
1. Du kan högerklicka och inspektera tre lager i färgspelaren
   **Felsöka innehåll**: Högerklicka och inspektera innehållet för att felsöka det innehåll som körs (det ska finnas ett enda alternativ som heter Inspektera på snabbmenyn)
