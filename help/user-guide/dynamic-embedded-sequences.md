...
***Dynamiska inbäddade sekvenser*** skapas för stora projekt som följer efter den överordnade underordnade hierarkin, där den underordnade refereras inuti en platsmapp och inte en kanalmapp. Det gör att användaren kan bädda in en sekvens inuti en kanal med ***Kanalroll***. Det gör att användaren kan definiera platsspecifika platshållare för olika kontor med hjälp av en inbäddad sekvens inuti en huvudkanal.
...
Referera till en *Kanal efter roll* Med kan du skapa en lokal version av en kanal för att dynamiskt matcha platsspecifikt innehåll och även skapa en global kanal som utnyttjar innehållet för de platsspecifika kanalerna.
...
>
>***Dynamiska inbäddade sekvenser*** gör att du kan visa platsspecifikt innehåll medan ***Inbäddade sekvenser*** bara visa det allmänna bildspelet av innehållet. När du konfigurerar dynamiska inbäddade sekvenser måste du dessutom konfigurera kanalen med kanalroll och namn. Se stegen nedan för en praktisk implementering.
>
...
* ***enskilda sekvenskanaler*** på respektive plats med *roll* i den visning som matchar **dynamisk inbäddad sekvenskomponent *roll*.**
...
>[!CAUTION]
>
>Var försiktig med **Namn** och **Titel** fält när kanaler skapas under varje plats. Följ instruktionerna i nomenklaturen noga.
...
1. **Skapa två platser och en kanal under varje platsmapp.**
   ...
   >[!CAUTION]
   >
   >Kontrollera att när du skapar kanal **Region A**, anger **Titel** as **Region A** och **Namn** as **region**.
...
1. **Skapa Visning och Kanal under varje plats.**
   ...
   >I det här exemplet är kanalerna under **Region A** och **Region B** dela samma **Namn** as **region** och kanaler under **Butik 1**, **Butik 2**, **Butik 3** och **Butik 4** dela samma **Namn** as **store**.

   ![screen_shot_2018-09-19at120206pm](assets/screen_shot_2018-09-19at120206pm.png)

   På samma sätt kan du skapa en visning som **Store2Display** och en kanal **Store2Channel** under **Butik 2** (med namn som **store**).

   >[!NOTE]
   >Se till att du kan använda samma namn för de kanaler som skapas i **Butik 1** och **Butik 2** as **store**.

   ![screen_shot_2018-09-19at120329pm](assets/screen_shot_2018-09-19at120329pm.png)

   Följ de föregående stegen för att skapa en kanal och visa i **Butik 3** och **Butik 4** under **Region B**. Se till att du använder samma **Namn** as **store** när kanal skapades **Store3Channel** och **Store4Channel** respektive.

   I följande bild visas visningen och kanalen i **Butik 3**.

   ![screen_shot_2018-09-19at120448pm](assets/screen_shot_2018-09-19at120448pm.png)

   I följande bild visas visningen och kanalen i **Butik 4**.
...
1. **Lägg till innehåll i kanalerna på deras respektive platser.**
   ...
   >[!NOTE]
   >Du kan använda ***Resources.zip*** från **Resurser** ovan om du vill använda bilderna som resurser för ditt kanalinnehåll.
...
1. **Skapa ett schema**
   ...
   Navigera och markera **Scheman** i ditt AEM Screens-projekt och klicka **Skapa** i åtgärdsfältet för att skapa ett nytt schema.

   Följande bild visar **AdSchedule** skapad i **Demo** projekt.
...
1. **Tilldela kanaler till ett schema**
   ...
   1. Klicka **+ Tilldela kanal** från **TILLDELADE KANALER** för att öppna **Kanaltilldelning** -dialogrutan.
...
1. **Konfigurerar dynamisk inbäddad sekvens till den globala kanalen.**
   ...
   Klicka **Redigera** för att öppna redigeraren.

   ![screen_shot_2018-09-13at52754pm](assets/screen_shot_2018-09-13at52754pm.png)

   Dra och släpp två **Dynamisk inbäddad sekvens** -komponenter i kanalredigeraren.

   Öppna egenskaperna från en av komponenterna och ange **Kanaltilldelningsroll** as **RegionAdSegment**.

   På samma sätt markerar du den andra komponenten och öppnar egenskaper för att ange **Kanaltilldelningsroll** as **StoreAdSegment**.
...
Om du tilldelar visningssökvägen som **Demo** —> **Platser** —> **Region A** —> **Butik 1** —> **Store1Display** visas följande innehåll i din AEM Screens-spelare.

![channeldisplay1](assets/channeldisplay1.gif)

**Scenario 1**:

Om du tilldelar visningssökvägen som **Demo** —> **Platser** —> **Region B** —> **Butik 3** —> **Store3Display** visas följande innehåll i din AEM Screens-spelare.
...
* **Store-Author**: Innehåller endast användare som har läs-, skriv- och redigeringsbehörighet till **Butik 1**, **Butik 2**, **Butik 3** och **Butik 4**.
...
>[!NOTE]
>
>Om du vill veta mer om hur du fördelar projekt med ACL:er så att varje enskild person eller grupp hanterar sitt eget projekt kan du läsa mer i **Konfigurera åtkomstkontrollistor**.
...
1. **Skapa användare och lägga till användare i grupper**
   ...
   1. Retur **Lösenord** och bekräfta lösenordet för den här användaren.
   1. Klicka på **Grupper** och ange gruppnamnet i **Välj grupp**, t.ex. enter **Global-Author** lägga till **Global-användare** till den specifika gruppen.
   1. Klicka **Spara och stäng**.
...
1. **Ändra behörigheter för varje grupp**
   ...
   **För global författare:**
   ...
   Följande bild visar att nu är **Global-användare** har åtkomst till **Global kanal** och både **Region A** och **Region B** med alla fyra butikerna, **Butik 1**, **Butik 2**, **Butik 3** och **Butik 4**.
   ...
   **För Region-Author:**
   ...
   1. Navigera till ***/content/screens/demo/channel*** och avkontrollera behörigheterna för **Global** kanal.
   1. Navigera till ***/content/screens/demo/locations***/***region-a*** och kontrollera alla behörigheter. På samma sätt kontrollerar du behörigheterna för **region-b**.
   ...
   Bilden nedan visar att Region-User nu har åtkomst till båda **Region A** och **Region B** med alla fyra butikerna, **Butik 1**, **Butik 2**, **Butik 3** och **Butik 4** men har inte åtkomst till **Global** Kanal.
   ...
   **För Store-Author:**
   ...
   Följande bild visar att nu är **Butiksanvändare** endast har tillgång till fyra butiker, nämligen **Butik 1**, **Butik 2**, **Butik 3** och **Butik 4** men har inte behörighet att komma åt **Global** eller regionen (**Region A** och **Region B**) kanaler.
