...
1. **Tilldela kanaler att visa**
   ...
   1. I **Kanaltilldelning** dialogruta, klicka **Referenskanal** efter bana.
   1. Klicka på **Kanalsökväg** och sedan klicka **Aktivering på kanalnivå** > ***Kanaler*** > ***MainAdChannel***.
   1. The **Kanalroll** fylls i som **huvudkanal**.
   1. Klicka på **Prioritet** och ange till **1**.
   1. Klicka på **Händelser som stöds** som **Inledande inläsning** och **Inaktiv skärm**.
   1. Klicka **Spara**.
   ...
   1. Navigera till **Aktivering på kanalnivå** > **Platser** > **Län** > **RegionDisplay** och klicka **Tilldela kanal** i åtgärdsfältet.
   1. I **Kanaltilldelning** klickar du på **Referenskanal** efter bana.
   1. Klicka på **Kanalsökväg** och sedan klicka **Aktivering på kanalnivå** > ***Kanaler*** > ***TargetedSinglePlay***.
   1. The **Kanalroll** fylls i som **målsingleplay**.
   1. Ange **Prioritet** till **2**.
   1. Klicka på **Händelser som stöds** och ange **Inledande inläsning**, **Inaktiv skärm** och **Timer**, vilket visas i figuren nedan.
   1. I **aktiv från**, anges som 27 november 2018, 11:59, och i **aktiv tills**, som anges som 28 november 2018, 12:05
   1. Klicka **Spara**.
