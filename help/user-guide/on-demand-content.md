...
## Hantera publikation: Leverera innehållsuppdateringar från författare till Publish till enhet {#managing-publication-delivering-content-updates-from-author-to-publish-to-device}
...
1. Klicka på **+ Inkludera underordnade** i åtgärdsfältet och avmarkera alla alternativ så att du kan publicera alla moduler i projektet och klicka på **Lägg till** för att publicera.
   ...
   **Dialogrutan Inkludera underordnade** är här
...
1. Klicka på **Publish** i **`Manage Publication wizard`**.
   ...
   >    1. Arbetsflödet fungerar inte om författaren inte slutför replikeringsprocessen (innehållet överförs fortfarande till publiceringsinstansen) efter att ha markerat knappen **Publish** i arbetsflödet för att hantera publicering.
...
1. Navigera till projektet och klicka på **Uppdatera offlineinnehåll** i åtgärdsfältet. Den här åtgärden vidarebefordrar samma kommando till publiceringsinstansen, så att offlinezippen skapas även i din Publish-instans.
...
Följ stegen nedan för att leverera innehållsuppdateringar från Författare > Publish > en enhet för en kanal i ett AEM Screens-projekt:
...
1. Klicka på **Publish** i guiden **`Manage Publication`**.
...
1. **Uppdatera offlineinnehåll** i kanalkontrollpanelen utlöser bara offlineinnehåll till författarinstansen, men inte till publiceringsinstansen. Steg 1-4 används för att överföra offlineinnehåll till Publish-instanser.

   ![screen_shot_2019-02-07at21608pm](assets/screen_shot_2019-02-07at21608pm.png)

   >[!CAUTION]
   >
   >Publish startar först uppdateringen av offlineinnehållet enligt beskrivningen i föregående steg.
