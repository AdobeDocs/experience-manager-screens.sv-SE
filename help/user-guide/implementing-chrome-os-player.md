...
1. Klicka på AEM Screens Player i Chrome Web Store.

   >[!NOTE]
   >
   >En nyligen publicerad app kan ta ca 15 minuter att visa i den här listan.

1. Klicka **AEM Screens Player** från **Starta Kiosk-appen automatiskt** nedrullningsbar meny.
...
1. Klicka **Kiosk-inställningar** och klicka på din organisation (*om en testmiljö används*).
