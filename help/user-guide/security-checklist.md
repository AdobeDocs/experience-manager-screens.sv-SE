...
| **Åtkomstkontroll** | **a.** *Har du en rollbaserad åtkomstkontroll (RBAC) identifierad och hanterad internt?* <br>**b.** *Har du följt principen om minst privilegium att ge åtkomst till författare, administratörer och spelare med hjälp av de bästa metoderna från Adobe?* |
