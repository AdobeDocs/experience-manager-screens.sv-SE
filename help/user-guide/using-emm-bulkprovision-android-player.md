...
1. Registrera dina Android-enheter med din EMM-lösning som stöder Appconfig.
...
1. Konfigurera de här parametrarna och spara och distribuera principen till enheterna.
