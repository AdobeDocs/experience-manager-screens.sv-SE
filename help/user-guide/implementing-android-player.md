...
Med metoden Ad-Hoc kan du installera den senaste Android-spelaren (*.exe*). Besök [**AEM 6.5 Player Downloads**](https://download.macromedia.com/screens/) sida.
...
1. Hämta plattformsknapparna från tillverkaren för att få en *pk8* och *pem* fil
...
Se en [Exempel på JSON-princip](#example-json) samt en tabell som beskriver hur de olika [Principattribut](#policy-attributes).
